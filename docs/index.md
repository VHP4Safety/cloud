...
available [here](catalog.md). The catalog is internally stored as a collection of JSON files with [this template](https://github.com/VHP4Safety/cloud/blob/main/docs/service/template.json). 
