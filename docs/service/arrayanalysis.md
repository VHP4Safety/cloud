...
An user-interface for preprocessing and statistically analyzing RNA-sequencing and microarray transcriptomics data.
...
<script type="application/ld+json">
  {
    ...
    "name": "ArrayAnalysis",
    "description": "An user-interface for preprocessing and statistically analyzing RNA-sequencing and microarray transcriptomics data.",
